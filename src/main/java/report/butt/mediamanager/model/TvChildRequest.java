...
public class TvChildRequest extends TvRequest {
  ...
  public TvChildRequest(TvRequest parent, String title, Integer tvdbId, Boolean ombiAvailable,
      Integer ombiRequestId, String ombiRequestStatus) {
  ...
  public boolean isAvailable() {
    return Boolean.TRUE.equals(getOmbiAvailable())
  ...
  public String toString() {
    return String.format(
        ...
        getId(), parent == null ? null : parent.getId(), getTitle(), getOmbiRequestId(),
