...
@Entity
@Table(name = "tv_episode_request", uniqueConstraints = @UniqueConstraint(
...
public class TvEpisodeRequest {
  ...
  public TvEpisodeRequest(TvSeasonRequest tvSeasonRequest, Integer ombiEpisodeId,
  ...
  public String toString() {
    return String.format(
        ...
        id, tvSeasonRequest == null ? null : tvSeasonRequest.getId(), ombiEpisodeNumber,
        ombiAvailable);
  }
}
