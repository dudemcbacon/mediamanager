...
@Entity
@Table(name = "tv_season_request", uniqueConstraints = @UniqueConstraint(
...
public class TvSeasonRequest {
  ...
  public TvSeasonRequest(TvChildRequest tvChildRequest, Integer ombiSeasonRequestId,
      Integer ombiSeasonNumber, Boolean ombiSeasonAvailable) {
  ...
  public String toString() {
    return String.format(
        ...
        id, tvChildRequest == null ? null : tvChildRequest.getId(), ombiSeasonNumber,
        ombiSeasonAvailable);
  }
}
