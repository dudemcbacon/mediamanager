...
public class MovieRequestView extends VerticalLayout {
  ...
  public MovieRequestView(MovieRequestRepository movieRequestRepository, MovieController movieController,
  ...
  private void refreshGrid() {
    ...
    noteRepository.findAll().forEach(n -> movieRequestsWithNotes.add(n.getRequest().getId()));
